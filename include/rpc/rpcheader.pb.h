...
public:
    ...
    explicit PROTOBUF_CONSTEXPR
        RpcHeader(::google::protobuf::internal::ConstantInitialized);
    ...
    static const RpcHeader& default_instance() { return *internal_default_instance(); }
    static inline const RpcHeader* internal_default_instance() {
        return reinterpret_cast<const RpcHeader*>(&_RpcHeader_default_instance_);
    }
...
public:
    ...
    ::uint8_t*
    _InternalSerialize(::uint8_t* target,
...
private:
    ...
    _internal_set_service_name(const std::string& value);
...
private:
    ...
    inline PROTOBUF_ALWAYS_INLINE void
    _internal_set_method_name(const std::string& value);
...
private:
    ...
    static constexpr const void* _raw_default_instance_ = &_RpcHeader_default_instance_;
...
inline const std::string& RpcHeader::service_name() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline const std::string& RpcHeader::method_name() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
    // @@protoc_insertion_point(field_get:RPC.RpcHeader.method_name)
    return _internal_method_name();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void RpcHeader::set_method_name(Arg_&& arg, Args_... args) {
    ::google::protobuf::internal::TSanWrite(&_impl_);
