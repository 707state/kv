...
inline constexpr RpcHeader::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : service_name_(&::google::protobuf::internal::fixed_address_empty_string,
                    ::_pbi::ConstantInitialized())
    , method_name_(&::google::protobuf::internal::fixed_address_empty_string,
                   ::_pbi::ConstantInitialized())
    , args_size_{0u}
    , _cached_size_{0} {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    RpcHeaderDefaultTypeInternal _RpcHeader_default_instance_;
} // namespace RPC
...
const ::uint32_t TableStruct_rpcheader_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u, // no _has_bits_
...
RpcHeader::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                        ::google::protobuf::Arena* arena,
                        const Impl_& from,
                        const ::RPC::RpcHeader& from_msg)
    : service_name_(arena, from.service_name_)
    , method_name_(arena, from.method_name_)
    , _cached_size_{0} {}

RpcHeader::RpcHeader(::google::protobuf::Arena* arena, const RpcHeader& from)
    : ::google::protobuf::Message(arena) {
        ...
        RpcHeader::_table_ = {
            {
                ...
                ::_pbi::TcParser::GetTable<::RPC::RpcHeader>(), // to_prefetch
...
::uint8_t*
RpcHeader::_InternalSerialize(::uint8_t* target,
...
::size_t RpcHeader::ByteSizeLong() const {
    ...
    if (this->_internal_args_size() != 0) {
        total_size +=
            ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_args_size());
    }
...
void RpcHeader::InternalSwap(RpcHeader* PROTOBUF_RESTRICT other) {
    ...
    ::_pbi::ArenaStringPtr::InternalSwap(
        &_impl_.service_name_, &other->_impl_.service_name_, arena);
    ::_pbi::ArenaStringPtr::InternalSwap(
        &_impl_.method_name_, &other->_impl_.method_name_, arena);
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type _static_init2_
    PROTOBUF_UNUSED = (::_pbi::AddDescriptors(&descriptor_table_rpcheader_2eproto),
                       ::std::false_type{});
