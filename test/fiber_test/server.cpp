...
// task
void watch_io_read() {
    ::IOManager::GetThis()->addEvent(listen_sock, ::READ, test_accept);
}
...
void test_accept() {
    ...
    if (fd < 0) {
        ...
        ::IOManager::GetThis()->addEvent(fd, ::READ, [fd]() {
            char buffer[1024];
    ...
    ::IOManager::GetThis()->scheduler(watch_io_read);
}
...
void test_iomanager() {
    ...
    ::IOManager iomanager;
    iomanager.addEvent(listen_sock, ::READ, test_accept);
}
