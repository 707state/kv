...
void test_fiber_1() {
    std::cout << LOG_HEAD << "tid = " << ::GetThreadId() << ",test_fiber_1 begin"
              << std::endl;

    std::cout << LOG_HEAD << "tid = " << ::GetThreadId() << ",test_fiber_1 finish"
              << std::endl;
}

void test_fiber_2() {
    std::cout << LOG_HEAD << "tid = " << ::GetThreadId() << ",test_fiber_2 begin"
              << std::endl;
    // no hook 直接将当前协程阻塞，等效于将当前线程阻塞
    sleep(3);
    std::cout << LOG_HEAD << "tid = " << ::GetThreadId() << ",test_fiber_2 finish"
              << std::endl;
}

void test_fiber_3() {
    std::cout << LOG_HEAD << "tid = " << ::GetThreadId() << ",test_fiber_3 begin"
              << std::endl;

    std::cout << LOG_HEAD << "tid = " << ::GetThreadId() << ",test_fiber_3 finish"
              << std::endl;
}

void test_fiber_4() {
    std::cout << LOG_HEAD << "tid = " << ::GetThreadId() << ",test_fiber_4 begin"
              << std::endl;

    std::cout << LOG_HEAD << "tid = " << ::GetThreadId() << ",test_fiber_4 finish"
              << std::endl;
}
